          ...
          <View style={Estilos.containnerMain}>
            ...
            <View style={Estilos.containnerProduto}>
              <View style={Estilos.viewAbastecer}>
                ...
                <LinearGradient
                  ...
                  style={Estilos.gradientTouchXL}>
                  <TouchableOpacity onPress={(value) =>
                    setAbastecer(prod_seven, produtoSeven.abastecimento) & getAbastecer(prod_seven)}>
                    <Text style={Estilos.touchText}>Abastecer</Text>
                  </TouchableOpacity>
                </LinearGradient>
                <LinearGradient
            ...
            <View style={Estilos.containnerProduto}>
              <View style={Estilos.viewAbastecer}>
                ...
                <LinearGradient
                  ...
                  style={Estilos.gradientTouchXL}>
                  <TouchableOpacity onPress={(value) =>
                    setAbastecer(prod_eight, produtoEight.abastecimento) & getAbastecer(prod_eight)}>
                    <Text style={Estilos.touchText}>Abastecer</Text>
                  </TouchableOpacity>
                </LinearGradient>
                <LinearGradient
            ...
            <View style={Estilos.containnerProduto}>
              <View style={Estilos.viewAbastecer}>
                ...
                <LinearGradient
                  ...
                  style={Estilos.gradientTouchXL}>
                  <TouchableOpacity onPress={(value) =>
                    setAbastecer(prod_nine, produtoNine.abastecimento) & getAbastecer(prod_nine)}>
                    <Text style={Estilos.touchText}>Abastecer</Text>
                  </TouchableOpacity>
                </LinearGradient>
                <LinearGradient
            ...
            <View style={Estilos.viewAmount}>
              <Text style={Estilos.textInfo}>
                {`Valor total Dinheiro R$ ${produtoOne.pgtoDn +
                  produtoTwo.pgtoDn +
                  produtoThree.pgtoDn +
                  produtoFour.pgtoDn +
                  produtoFive.pgtoDn +
            ...
            <View style={Estilos.viewShare}>
              ...
              <TouchableOpacity
                onPress={(value) =>
                  ...
                  setZerar(prod_seven, "0") & getZerar(prod_seven) &
                  setZerar(prod_eight, "0") & getZerar(prod_eight) &
                  setZerar(prod_nine, "0") & getZerar(prod_nine) &
                  clearStorag
                }
